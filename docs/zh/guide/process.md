...
进程管理页面提供对 MSM 管理的所有服务进程的集中控制，包括启停、重启和状态监控。

## 页面概览

点击 **侧边栏 → 进程管理** 进入进程管理页面。

页面以卡片形式展示每个服务的运行状态，包括：
...
|------|------|----------|
| **MosDNS** | DNS 分流引擎 | 53 |
| **Mihomo** | Mihomo 代理内核 | 7890/7891/7892 |
| **Sing-Box** | Sing-Box 代理内核 | 7890/7891/7892 |

::: info 说明
Mihomo 和 Sing-Box 是两种可选的代理内核，通常只需启用其中一个。
:::
...
::: tip 启动顺序
建议先启动 MosDNS（DNS 服务），再启动代理内核（Mihomo 或 Sing-Box），确保 DNS 分流就绪后代理才开始工作。
:::
...
- [MosDNS 管理](/zh/guide/mosdns) - DNS 分流详细配置
- [Mihomo 管理](/zh/guide/mihomo) - Mihomo 代理管理
- [SingBox 管理](/zh/guide/singbox) - Sing-Box 代理管理
