...
> 当前 Beta 版本：`beta-1.0.25`  
> 发布时间：2026-04-16 11:51:38 CST  
> - 发布页：<https://github.com/msm9527/msm-wiki/releases/tag/beta-1.0.25>  
...
### 🐛 修复（Fixed）
- 修复更新下载及安装流程，避免误装 Beta 版及版本异常。
- 修复日志页循环请求及渲染性能问题。
- 修复轮播、外观及进程页弹窗相关问题。
- 修复 MosDNS 升级后配置恢复超时问题。
- 修复规则集 payload 序列化导致的崩溃。
- 修复本地服务 HTTP 请求绕过代理逻辑。
...
::: details 📋 构建信息
- **发布通道**: beta（Beta 版）
- **源提交**: [`3d5fa38`](https://github.com/msm9527/msm/commit/3d5fa388e9a7045a22ef23e2a6282c2098243411)
- **提交信息**: chore: sync version to 1.0.25
- **提交作者**: github-actions[bot]
- **提交时间**: 2026-04-16 11:51:38 CST
:::
