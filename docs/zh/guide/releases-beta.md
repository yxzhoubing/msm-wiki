...
### 🐛 修复（Fixed）
- 修复更新重启死循环及备份清理
- 修复更新下载跳过中转避免 Beta 版本
- 修复强制更新安装重启及版本显示
- 修复嵌入式前端黑屏及构建问题
- 修复 MosDNS 规则查询及配置恢复超时
...
### 📝 备注（Notes）
- 0.x 升级 1.x 需重装或重置安全重下 DNS 服务

::: details 📋 构建信息
- **发布通道**: beta（Beta 版）
- **源提交**: [`600e9a9`](https://github.com/msm9527/msm/commit/600e9a91ee5f223bbbe26259b8464c4d1e8c40b7)
- **提交信息**: 恢复 MosDNS 规则源时改为异步刷新 / Make MosDNS rule-source refresh async during restore
- **提交作者**: root
- **提交时间**: 2026-04-21 17:14:47 CST
:::
