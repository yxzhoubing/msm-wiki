...
hero:
  name: "MSM"
  text: "统一管理平台"
  tagline: 基于 MosDNS + Clash / Sing-Box 的智能 DNS 分流与透明代理管理平台
  image:
...
features:
  ...
  - icon: 🔄
    title: 双内核代理
    details: 同时支持 Clash 和 Sing-Box，便于按自己的使用习惯选择内核
  - icon: 🛡️
    title: 设备级控制
...
MSM 是一套围绕 **MosDNS + Clash / Sing-Box** 构建的旁路由方案。  
...
7. [代理服务（Clash）](/zh/guide/mihomo) 或 [代理服务（Sing-Box）](/zh/guide/singbox)
